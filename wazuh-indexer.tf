...
wget -O /etc/wazuh-indexer/certs/root-ca.pem https://letsencrypt.org/certs/lets-encrypt-r3.pem
wget -O /etc/wazuh-dashboard/certs/root-ca.pem https://letsencrypt.org/certs/lets-encrypt-r3.pem
